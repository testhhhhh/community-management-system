...
<body>
    <div class="wrap">
        <div class="container">
            <h1>欢迎</h1>
            <c:if test="${param.error =='uname' }"><font color=red >用户名或密码错误</font></c:if>
            ...
            <form name="myform" action="Login" method="post">
                ...
                <input type="submit" value="登录" onclick="check(this)"/>
                <input name="lru" type="hidden"  value="login"/>
                <input name="log" type="hidden" value="log"/>
            </form>
            <div>
                <a href="https://github.com/login/oauth/authorize?client_id=f0c2aab30ce88a795d7c&state=STATE&redirect_uri=http://localhost:8080/GithubLogingCallBack;">
