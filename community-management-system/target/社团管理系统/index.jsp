		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<c:if test="${login == null}">
					<li class="y-in"><a href="login.jsp" style="{color:#F7F7F7;}">登陆</a></li>
...
<div id="container">
    <ul class="noticeList">
        <li><a href="info/activityDetil.jsp" title=""  target="_Blank">创业协会2022.5.25创客空间活动室   :针对“大众创新万众创业”活动开展相应培训</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">计算机协会2023.11.6计算机科研室    :举办大学生“Oracl"甲骨文ACM竞赛</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">天文地理协会 2012.10.9教学楼103 :"走进天文，探索奥秘"主题活动，讲解天体观测</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">数学应用协会 2088.5.6  教学楼505 :数学课堂知识模拟大赛</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">English.net协会 2011.3.20	 成栋教阶三	:“新生杯”英语演讲比赛海选赛</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">English.net协会  2016.3.25 成栋教阶三	:“新生杯”英语演讲比赛决赛、颁奖仪式</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">心理健康协会 20166.11.11	研楼436 :“阳光之旅”系列心理健康教育活动宣讲会</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">阳光公益社	2640.4.28  幸福中心小学  :深入课堂，走进学生身边开展支教活动 </a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">健身协会  2060.5.6  体育馆健身馆	:普及健康知识，进行健身动作讲解</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">魔术协会 2096.5.20	大学生活动中心  :魔术巅峰展演</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">排球协会  2416.6.6 北区体育场  :校园排球友谊赛开幕式</a></li>
    </ul>
</div>
...
<section class="footer">
	<h2 class="text-center">THANKS FOR VISITING US</h2>
		<p>
			<a href="#" target="_blank">家里蹲大学官网</a>|
			<a href="#" target="_blank">家里蹲大学教务处</a>|
			<a href="#" target="_blank">家里蹲大学网络中心</a>
		</p><br>
		<p></p>
		<div id="Result">
