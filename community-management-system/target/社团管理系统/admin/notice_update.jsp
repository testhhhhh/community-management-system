...
<%--  <tr>--%>
<%--    <td width="99%" align="left" valign="top">您的位置：社团管理&nbsp;&nbsp;>&nbsp;&nbsp;公告信息</td>--%>
<%--  </tr>--%>
<%--  <tr>--%>
<%--    <td align="left" valign="top" id="addinfo">--%>
<%--    <a  target="mainFrame"  class="">更新公告</a>--%>
<%--        <c:if test="${param.rs =='namewrong' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>没有此公告，请先添加</b></font></c:if>--%>
...
<%--        <input type="text" readonly="true" name="noticeId" value="${notice.noticeId }" class="text-word">--%>

<%--        <td align="right" valign="middle" class="borderright borderbottom bggray">公告名：</td>--%>
<%--        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">--%>
<%--        <input type="text" name="noticeName" value="${notice.noticeName }" class="text-word">--%>
<%--        </td>--%>
<%--      </tr>--%>
<%--        <tr>--%>
<%--        <td align="right" valign="middle" class="borderright borderbottom bggray">公告内容：</td>--%>
<%--        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">--%>
<%--        <input type="text"  name="noticeIntroduction" value="${notice.noticeIntroduction}" class="text-word">--%>

<%--        <td align="right" valign="middle" class="borderright borderbottom bggray">社团id：</td>--%>
<%--        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">--%>
<%--        <input type="text"  readonly="true" name="communityId" value="${notice. communityId }" class="text-word">--%>
<%--        </td>--%>
<%--        </tr>--%>
<%--        <tr>--%>
<%--          <td align="right" valign="middle" class="borderright borderbottom bggray">公告时间：</td>--%>
<%--          <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">--%>
<%--            <input type="text"  readonly="true" name="noticeTime" value="${notice.noticeTime }" class="text-word">--%>

<%--          <td align="right" valign="middle" class="borderright borderbottom bggray">社团名称：</td>--%>
<%--          <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">--%>
<%--            <input type="text"  readonly="true" name="communityName" value="${notice. communityName }" class="text-word">--%>
<%--          </td>--%>
<%--        </tr>--%>
<%--       --%>
<%--      <tr>--%>
<%--      	<td>--%>
<%--      		 <input name="ope" type="hidden" value="noticeupdate"/>--%>
<%--      	</td>--%>
<%--      </tr>--%>
<%--      --%>
<%--      <tr>--%>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
          ...
          <tr>
            ...
            <tr>
              <td align="right" valign="middle" class="borderright borderbottom bggray">公告内容：</td>
              <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
<%--                <input type="text"  name="noticeIntroduction" value="${notice.noticeIntroduction}" class="text-word" type="hidden">--%>
                <script id="container" name="noticeIntroduction" type="text/plain" style="width:1000px;height:1000px;">
                    ${notice.noticeIntroduction}
                </script>
            </tr>
          <tr>
            <td align="center" valign="middle" class="borderright borderbottom main-for" colspan="2" style="padding-left:38%; border-right:none;">
