...
<%--        <a href="community_add.jsp" target="mainFrame" onFocus="this.blur()">添加社团</a>--%>
        ...
        <a href="Query?lru=alist" target="mainFrame" onFocus="this.blur()">社团活动</a>
        <a href="activity_add.jsp" target="mainFrame" onFocus="this.blur()">编辑活动</a>
        <a href="Query?lru=nlist" target="mainFrame" onFocus="this.blur()">社团公告</a>
        <a href="notice_add.jsp" target="mainFrame" onFocus="this.blur()">编辑公告</a>
      </div>
      <div>
        <span>财务管理</span>
        <a href="Query?lru=costlist" target="mainFrame" onFocus="this.blur()">财务信息</a>
      </div>
      <div>
        <span>审核管理</span>
        <a href="Query?lru=applylist" target="mainFrame" onFocus="this.blur()">入团申请审批</a>
      </div>
      <div>
        <span>系统监控</span>
        <a href="/druid/sql.html" target="mainFrame" onFocus="this.blur()">SQL监控</a>
      </div>
    </div>
</body>
</html>