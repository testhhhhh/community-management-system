vvv<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false" %>
...
<%--            <li><a href="notice.jsp">${notice.noticeName}</a></li>--%>
<%--                </c:forEach>--%>
<%--            </ul>--%>
<%--            <ul id="p2">--%>
<%--            </ul>--%>
...
<%--        </section>--%>
        ...
        <section class="about_our_team_area">
            ...
            <a href="/alipay?aid=${activity.activityId}&loginname=${login.loginName}">我要参加</a>
