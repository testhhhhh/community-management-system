...
<%--        <td align="center" valign="middle" class="borderright borderbottom tdb">${act.activityName}</td>--%>
<%--        <td align="center" valign="middle" class="borderright borderbottom">${act.activityDate }</td>--%>
<%--        <td align="center" valign="middle" class="borderright borderbottom tdb">${act.communityName }</td>--%>
<%--        <td align="center" valign="middle" class="borderright borderbottom">${act.activityPlace }</td>--%>
<%--        <td align="center" valign="middle" class="borderright borderbottom tdb">${act.activityInfo }</td>--%>
<%--        <td align="center" valign="middle" class="borderbottom"><a href="${pageContext.request.contextPath}/ActivityInfo?aid=${act.activityId}" target="mainFrame" onFocus="this.blur()" class="add">修改</a>--%>
<%--            <span class="gray">&nbsp;|&nbsp;</span>--%>
<%--            <form id="del${status.index}" method="post" action="Update?ope=adele">--%>
<%--                <input type="hidden" name="aid" value="${act.activityId}" />--%>
        ...
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                <tr>
                    ...
                    <th align="center" valign="middle" class="borderright">活动地点</th>
<%--                    <th align="center" valign="middle" class="borderright">活动简介</th>--%>
                    <th align="center" valign="middle">查看编辑</th>
                </tr>
