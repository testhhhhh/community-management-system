...
public class Member {
	...
	private int joint_communityId;

	public int getJoint_communityId() {
		return joint_communityId;
	}

	public void setJoint_communityId(int joint_communityId) {
		this.joint_communityId = joint_communityId;
	}
	...
	public void setActivity_point(int activity_point) {
