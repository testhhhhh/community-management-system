    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab" >
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'" >
        ...
        <td align="center" valign="middle" class="borderbottom">
            <a style="display: block;margin-top: -10px; margin-bottom: -20px" href="${pageContext.request.contextPath}/MemberInfo?mname=${member.loginName }" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
            <form id="del${status.index}" method="post" action="Update?ope=dele">
                <input type="hidden" name="loginname" value="${member.loginName}" />
